...
func newSettingsGetCmd(flags *rootFlags) *cobra.Command {
	...
	cmd := &cobra.Command{
		Use:         "get <key>",
		Short:       "Get setting by key",
		Example:     "  peekaping-pp-cli settings get your-token-here",
		Annotations: map[string]string{"pp:endpoint": "settings.get", "pp:method": "GET", "pp:path": "/settings/key/{key}", "mcp:read-only": "true"},
