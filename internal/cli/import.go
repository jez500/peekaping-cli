...
but do not stop the import.`,
  ...
  peekaping-pp-cli import <resource> --input data.jsonl

  # Dry-run to preview without sending
  peekaping-pp-cli import <resource> --input data.jsonl --dry-run

  # Import from stdin
  cat data.jsonl | peekaping-pp-cli import <resource> --input -`,
