...
func newPeekapingAuthCreateCmd(flags *rootFlags) *cobra.Command {
	...
	cmd := &cobra.Command{
		Use:         "create",
		Short:       "Login admin",
		Example:     "  peekaping-pp-cli peekaping-auth create --email user@example.com",
		Annotations: map[string]string{"pp:endpoint": "peekaping-auth.create", "pp:method": "POST", "pp:path": "/auth/login"},
