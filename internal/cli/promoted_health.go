...
func newHealthPromotedCmd(flags *rootFlags) *cobra.Command {
	...
	cmd := &cobra.Command{
		Use:         "health",
		Short:       "Returns the current server health",
		Long:        "Returns the current server health",
		Example:     "  peekaping-pp-cli health",
		...
		RunE: func(cmd *cobra.Command, args []string) error {
			...
			data, prov, err := resolveReadWithStrategy(cmd.Context(), c, flags, "auto", "health", true, path, params, nil, cmd.ErrOrStderr())
			if err != nil {
