...
large datasets as it has no memory pressure.`,
  ...
  peekaping-pp-cli export <resource> --format jsonl --output data.jsonl

  # Export with limit
  peekaping-pp-cli export <resource> --format jsonl --limit 1000

  # Pipe to another tool
  peekaping-pp-cli export <resource> --format jsonl | jq '.id'`,
